 ...
 * @author IGA Tosiki
 */
public abstract class AbstractBlancoCalcWriter implements XMLReader {
    /**
     * コンテンツハンドラを記憶します。
     */
     ...
     */
    public void parse(final InputSource inputSource) throws IOException,
            SAXException {
     ...
     *             SAX例外が発生した場合。
     */
    public void parseWorkbook(final Workbook workbook) throws SAXException {
