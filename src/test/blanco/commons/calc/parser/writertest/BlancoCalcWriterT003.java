 ...
 * @author IGA Tosiki
 */
public class BlancoCalcWriterT003 extends TestCase {
    ...
    public void testBlancoCalcWriter() throws Exception {
        ...
        try {
            inStream = new BufferedInputStream(new FileInputStream(
                    "./test/calc/parser/writertest/templateT003.xlsx"));
            outStream = new BufferedOutputStream(new FileOutputStream(
                    "./tmp/test/calc/parser/writertest/t003x.out.xml"));
            inStreamDef = new BufferedInputStream(new FileInputStream(
                    "./test/calc/parser/writertest/BlancoCarecoApiTestMeta2MetaT003.xml"));
            outStreamExcel = new BufferedOutputStream(new FileOutputStream(
                    "./tmp/test/calc/parser/writertest/t003x.out.xlsx"));
