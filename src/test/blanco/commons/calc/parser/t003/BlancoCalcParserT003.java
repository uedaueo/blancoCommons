 ...
 *******************************************************************************/
package blanco.commons.calc.parser.t003;
 ...
 * @author IGA Tosiki
 */
public class BlancoCalcParserT003 extends TestCase {
    ...
    public void testBlancoCalcParser() throws Exception {
        ...
        try {
            inStream = new BufferedInputStream(new FileInputStream(
                    "./test/calc/parser/t003/t003.xls"));
            outStream = new BufferedOutputStream(new FileOutputStream(
                    "./tmp/test/calc/parser/t003.out.xml"));
            inStreamDef = new BufferedInputStream(new FileInputStream(
                    "./test/calc/parser/t003/t003.xml"));
