...
/**
 * blancoCommonsが利用するメッセージ。
 */
public class BlancoCommonsMessage {
    /**
     * メッセージをプロパティファイル対応させるための内部的に利用するリソースバンドルクラス。
     */
    protected final BlancoCommonsMessageResourceBundle fBundle = new BlancoCommonsMessageResourceBundle();

    /**
     * メッセージ定義ID[blancoCommons]、キー[MBVOJI01]の文字列を取得します。
     *
     * No.2:
    ...
    /**
     * メッセージ定義ID[blancoCommons]、キー[MBVOJI02]の文字列を取得します。
     *
     * No.3:
    ...
    /**
     * メッセージ定義ID[blancoCommons]、キー[MBVOJI03]の文字列を取得します。
     *
     * No.4:
    ...
    /**
     * メッセージ定義ID[blancoCommons]、キー[MBVOJI04]の文字列を取得します。
     *
     * No.5:
    ...
    /**
     * メッセージ定義ID[blancoCommons]、キー[MBVOJI05]の文字列を取得します。
     *
     * No.6:
    ...
    /**
     * メッセージ定義ID[blancoCommons]、キー[MBVOJI06]の文字列を取得します。
     *
     * No.7:
    ...
    /**
     * メッセージ定義ID[blancoCommons]、キー[MBVOJA01]の文字列を取得します。
     *
     * No.10:
