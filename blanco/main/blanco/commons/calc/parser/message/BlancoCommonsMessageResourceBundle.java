package blanco.commons.calc.parser.message;
...
/**
 * メッセージ定義[blancoCommons]が内部的に利用するリソースバンドルクラス。
 *
 * リソースバンドル定義: [BlancoCommonsMessage]。<BR>
 * このクラスはリソースバンドル定義書から自動生成されたリソースバンドルクラスです。<BR>
 */
class BlancoCommonsMessageResourceBundle {
    /**
     * リソースバンドルオブジェクト。
     *
    ...
    /**
     * BlancoCommonsMessageResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoCommonsMessage]、デフォルトのロケール、呼び出し側のクラスローダを使用して、リソースバンドルを取得します。
     */
    public BlancoCommonsMessageResourceBundle() {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/commons/calc/parser/message/BlancoCommonsMessage");
     ...
     * BlancoCommonsMessageResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoCommonsMessage]、指定されたロケール、呼び出し側のクラスローダを使用して、リソースバンドルを取得します。
     *
     * @param locale ロケールの指定
     */
    public BlancoCommonsMessageResourceBundle(final Locale locale) {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/commons/calc/parser/message/BlancoCommonsMessage", locale);
        } catch (MissingResourceException ex) {
        }
    }
     ...
     * BlancoCommonsMessageResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoCommonsMessage]、指定されたロケール、指定されたクラスローダを使用して、リソースバンドルを取得します。
     *
     * @param locale ロケールの指定
     * @param loader クラスローダの指定
     */
    public BlancoCommonsMessageResourceBundle(final Locale locale, final ClassLoader loader) {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/commons/calc/parser/message/BlancoCommonsMessage", locale, loader);
        } catch (MissingResourceException ex) {
        }
    }
    ...
    /**
     * bundle[BlancoCommonsMessage], key[MBVOJI01]
     *
    ...
    /**
     * bundle[BlancoCommonsMessage], key[MBVOJI02]
     *
    ...
    /**
     * bundle[BlancoCommonsMessage], key[MBVOJI03]
     *
    ...
    /**
     * bundle[BlancoCommonsMessage], key[MBVOJI04]
     *
    ...
    /**
     * bundle[BlancoCommonsMessage], key[MBVOJI05]
     *
    ...
    /**
     * bundle[BlancoCommonsMessage], key[MBVOJI06]
     *
    ...
    /**
     * bundle[BlancoCommonsMessage], key[MBVOJA01]
     *
