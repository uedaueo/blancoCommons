...
/**
 * 処理 [BlancoCommonsProcess]インタフェース。
 *
 * このインタフェースを継承して [blanco.commons.calc.parser.task]パッケージに[BlancoCommonsProcess]クラスを作成して実際のバッチ処理を実装してください。<br>
 */
interface BlancoCommonsProcess {
    /**
     ...
     */
    int execute(final BlancoCommonsProcessInput input) throws IOException, IllegalArgumentException;
